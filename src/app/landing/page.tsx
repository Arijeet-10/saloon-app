                                ...
                                <Link href={`/saloon/${saloon.id}`} key={saloon.id} className="block">
                                    <Card className="hover:shadow-xl transition-all duration-300 ease-in-out border-0 shadow-md overflow-hidden h-full">
                                        <div className="h-48 overflow-hidden relative">
                                            <img 
                                                src={saloon.image || "https://images.unsplash.com/photo-1616226384899-f9890b13d852?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fGJhcmJlcnxlbnwwfHwwfHx8MA%3D%3D&w=1000&q=80"} 
                                                alt={saloon.shopName} 
